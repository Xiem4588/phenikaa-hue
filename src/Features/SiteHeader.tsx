...
export default class SiteHeader extends HTMLElement {
    ...
    render() {
        this.innerHTML = `
            <div class="bg-[#1F3A71] text-white text-sm">
                <div class="whitespace-nowrap sm:animate-none animate-marquee flex justify-between items-center px-4 py-2 space-x-1" data-container-width="header-big">
                    <div class="flex space-x-6 items-center">
                        <div class="flex items-center space-x-1">
                            <span class="material-icons text-base">access_time</span>
                            <span>Thứ 2 - Thứ 7 9 AM - 5 PM</span>
                        </div>
                        <div class="flex items-center space-x-1">
                            <span class="material-icons text-base">phone</span>
                            <a href="/vntel:099xxxxxxxxx" class="text-blue-400 hover:underline break-all ">
                                099xxxxxxxxx
                            </a>
                        </div>
                    </div>
            ...
            <div class="main__header" aria-hidden="true" data-header-height>
                <div data-container-width="header-big">
                    <div class="main-menu-header__row">
                        <div class="main-menu-header__logo-left">
                            <a class="main-menu-header__logo " href="/" title="logo">
