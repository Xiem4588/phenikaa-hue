...
import './Component/SliderProductItem';

export default class SliderProduct extends HTMLElement {
    connectedCallback() {

        this.innerHTML = `
            <div class="slider-product-block">
                <div class="slider-product-grid" data-container-width="bodytext">
                    ...
                    <div class="swiper" data-slider-product>
                        <div class="swiper-wrapper">
                            <slider-product-item class="swiper-slide" set-teaser-layout="grid" set-teaser-breadcrumbs="false"></slider-product-item>
                            <slider-product-item class="swiper-slide" set-teaser-layout="grid" set-teaser-breadcrumbs="false"></slider-product-item>
                            <slider-product-item class="swiper-slide" set-teaser-layout="grid" set-teaser-breadcrumbs="false"></slider-product-item>
                            <slider-product-item class="swiper-slide" set-teaser-layout="grid" set-teaser-breadcrumbs="false"></slider-product-item>
                            <slider-product-item class="swiper-slide" set-teaser-layout="grid" set-teaser-breadcrumbs="false"></slider-product-item>
...
customElements.define('slider-product', SliderProduct);