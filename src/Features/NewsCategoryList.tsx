                ...
                <div class="lg:col-span-3 xl:col-span-2 flex flex-col gap-10">
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="flex justify-between items-center gap-5">
                            ...
                            <div class="flex-1">
                                <a href="/news-category" class="text-l xl:text-xl">Xem Tất Cả</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-5 xl:gap-15">
                        <div class="flex flex-col text-white">
                            <a class="max-w-[120px] md:max-w-[250px] decoration-animation-none" href="/news-detail">
                                <img alt="image" src="./src/assets/images/image-item-7.png">
                            </a>
                            <a class="f-montserrat p-2 md:mr-auto bg-gradient decoration-animation-none" href="/news-category">Tin ngành</a>
                        </div>
                        <div class="flex-1 flex flex-col justify-between">
                            <div class="max-w-sm flex flex-col gap-2 md:gap-5">
                                ...
                                <a class="text-xl xl:text-3xl font-medium decoration-animation-none" href="/news-detail">Tin 1</a>
                            ...
                            <div class="flex justify-between items-center gap-5 my-3">
                                ...
                                <div class="text-white">
                                    <a class="bg-gradient after-arrow-r p-4 decoration-animation-none" href="/news-category"></a> 
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="lg:col-span-2 xl:col-span-1 flex flex-col gap-10">
                    ...
                    <div class="flex flex-col gap-5">
                        <div class="flex gap-5">
                            <div class="flex flex-col text-white">
                                <a class="max-w-[95px] decoration-animation-none" href="/news-detail">
                                    <img alt="image" src="./src/assets/images/image-item-7.png">
                                </a>
                            </div>
                            <div class="flex-1 flex flex-col justify-between">
                                <div class="max-w-sm flex flex-col gap-2">
                                    <p class="small flex gap-5 items-center">Your Name <span class="before-dot-g">Nov 18, 2025</span></p>
                                    <a class="text-xl font-medium decoration-animation-none" href="/news-detail">Tin 1</a>
                                </div>
                                <div class="flex justify-between items-center text-orange-600 gap-5 my-3">
                                    <span class="border-b border-gray-300 flex-1"></span>
                                    <a class="tex-gradient m-4" href="/news-category">Đọc thêm</a>
                                </div>
                            </div>
                        </div>
                        <div class="flex gap-5">
