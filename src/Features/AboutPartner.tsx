...
export default class AboutPartner extends HTMLElement {
    innerHTML = `
        <div class="p-4 mt-10 md:mt-15">
            <div class="flex flex-col gap-10 text-center" data-container-width="bodytext">
                ...
                <div class="bg-white shadow px-6 py-20 my-10 lg:my-20 text-center">
                    ...
                    <div class="flex flex-col md:flex-row justify-center text-white  gap-4">
                        <a href="#" class="bg-orange-500 px-6 py-2 rounded hover:bg-orange-600 transition ">Xem thêm về Phenikaa Group</a>
                        <a href="#" class="bg-gray-900 px-6 py-2 rounded hover:bg-gray-600 transition ">Liên hệ ngay</a>
                    </div>
                </div>
            </div>
        </div>
